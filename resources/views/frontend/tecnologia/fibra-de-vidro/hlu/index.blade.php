@php
	$pagina = App\Pagina::returnPage('tecnologias-e-processos-fibra-de-vidro-hlu');
@endphp
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		{!! Breadcrumbs::render('tecnologia-e-processos-fibra-de-vidro-hlu') !!}

		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						{!! App\Conteudo::show('tecnologias-e-processos-fibra-de-vidro-hlu') !!}
					</div>
