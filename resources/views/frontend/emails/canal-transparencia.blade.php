...
<body>
	...
	<ul>
		...
		<li><strong>Motivo:</strong> {{ !empty($input['motivo']) ? $input['motivo'] : 'Não informado(a)' }}</li>
		<li><strong>O que aconteceu?:</strong> {{ !empty($input['oque_aconteceu']) ? $input['oque_aconteceu'] : 'Não informado(a)' }}</li>
		<li><strong>Quando aconteceu?:</strong> {{ !empty($input['quando_aconteceu']) ? $input['quando_aconteceu'] : 'Não informado(a)' }}</li>
		<li><strong>Outras informações?:</strong> {{ !empty($input['outras_informacoes']) ? $input['outras_informacoes'] : 'Não informado(a)' }}</li>
	</ul>
	<hr />
