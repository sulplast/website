<?php
	$pagina = App\Pagina::returnPage('meio-ambiente-ciclo-de-vida-do-produto');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('meio-ambiente-ciclo-de-vida-do-produto'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('meio-ambiente-ciclo-de-vida'); ?>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/meio-ambiente/ciclo-de-vida-do-produto.blade.php ENDPATH**/ ?>