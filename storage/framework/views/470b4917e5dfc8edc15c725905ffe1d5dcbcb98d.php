<?php
	$pagina = App\Pagina::returnPage('empresa-codigo-de-conduta-e-etica');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('empresa-codigo-conduta-etica'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('empresa-codigo-de-conduta-e-etica'); ?>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/empresa/codigo-conduta-etica.blade.php ENDPATH**/ ?>