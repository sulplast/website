...
<body>
	<div class="main">
		...
		<!-- Subpage header -->
		<?php echo $__env->make('frontend.layouts.components.sp-header', ['title' => 'Converse com o DPO Sulplast'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('converse-dpo'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
                        <?php echo $__env->make('frontend.converse-dpo.partials.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					</div>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/converse-dpo/index.blade.php ENDPATH**/ ?>