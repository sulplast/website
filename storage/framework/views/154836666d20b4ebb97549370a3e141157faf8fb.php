<?php
	$pagina = App\Pagina::returnPage('empresa-plano-de-contingencia');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('empresa-plano-de-contingencia'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('empresa-plano-de-contingencia'); ?>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/empresa/plano-de-contingencia.blade.php ENDPATH**/ ?>