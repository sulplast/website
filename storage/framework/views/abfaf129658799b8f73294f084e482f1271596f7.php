<?php
	$pagina = App\Pagina::returnPage('tecnologias-e-processos-termoplastico');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('tecnologia-e-processos-termoplastico'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('termoplastico-intro'); ?>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/tecnologia/termoplastico/index.blade.php ENDPATH**/ ?>