<?php
	$pagina = App\Pagina::returnPage('tecnologias-e-processos');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('tecnologia-e-processos'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('tecnologias-e-processos'); ?>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/tecnologia/index.blade.php ENDPATH**/ ?>