<?php
	$pagina = App\Pagina::returnPage('empresa-missao-e-visao');
?>
<!DOCTYPE html>
	...
	<div class="main">
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('empresa-missao-visao'); ?>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/empresa/missao-e-visao.blade.php ENDPATH**/ ?>