<div class="sp-sidebar">
	<div class="col-md-offset-1 col-md-3">
		<h4 class="h4"><?php echo e(__('fale_conosco.sidebar.telefones_para_contato')); ?></h4>
		<br>
		...
		<hr>
		<h4 class="h4"><?php echo e(__('fale_conosco.sidebar.email_para_contato')); ?></h4>
		<br>
		<ul class="list-style-sulplast list-style-sulplast-large">
		...
		<div class="card-link card-link-default card-link-hover-primary">
			<a href="<?php echo e(url_locale('fale-conosco.localizacao')); ?>">
				<span class="card-link-title"><?php echo e(__('fale_conosco.sidebar.mapa_localizacao')); ?></span>
				<span class="card-link-description"><?php echo e(__('fale_conosco.sidebar.mapa_localizacao_descricao')); ?></span>
				<i class="card-link-icon fa fa-map-marker-alt"></i>
			</a>
		</div>

		<?php if( ! Request::is('*trabalhe-conosco')): ?>
		<div class="card-link card-link-default card-link-hover-primary">
			<a href="<?php echo e(url_locale('trabalhe-conosco')); ?>">
				<span class="card-link-title"><?php echo e(__('fale_conosco.sidebar.trabalhe_conosco')); ?></span>
				<span class="card-link-description"><?php echo e(__('fale_conosco.sidebar.trabalhe_conosco_descricao')); ?></span>
			</a>
		</div>
		<?php endif; ?>
		...
		<?php if( Request::is('*trabalhe-conosco')): ?>
			<div class="card-link card-link-default card-link-hover-primary">
				<a href="<?php echo e(url_locale('vagas')); ?>">
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/fale-conosco/partials/sidebar.blade.php ENDPATH**/ ?>