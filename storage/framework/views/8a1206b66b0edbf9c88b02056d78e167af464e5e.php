<?php
	$pagina = App\Pagina::returnPage('certificacoes-e-premios');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('certificacoes-e-premios'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('certificacoes-e-premios'); ?>

					</div>
						
					<!-- Sidebar -->
					<?php echo $__env->make('frontend.certificacoes-e-premios.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/certificacoes-e-premios/index.blade.php ENDPATH**/ ?>