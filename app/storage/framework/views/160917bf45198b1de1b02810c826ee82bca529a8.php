...
<body>
	<div class="main">
		...
		<!-- Subpage header -->
		<?php echo $__env->make('frontend.layouts.components.sp-header', ['title' => 'Governança e Compliance'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('governanca-e-compliance'); ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8">
                        ...
                        <a href="<?php echo e(url_locale('canal-de-transparencia')); ?>" class="btn btn-primary my-2">Canal de transparência</a>
                        ...
                        <a href="<?php echo e(env('APP_URL')); ?>pt-br/pdf/politica-privacidade.pdf" class="btn btn-primary my-2">Política de Privacidade</a><br>
                        <a href="<?php echo e(env('APP_URL')); ?>pt-br/pdf/politica-seguranca-da-informacao.pdf" class="btn btn-primary my-2">Política de Segurança da Informação</a><br>
                        <a href="<?php echo e(url_locale('converse-dpo')); ?>" class="btn btn-primary my-2">Converse com o DPO Sulplast</a>
						...
						<a href="<?php echo e(url_locale('empresa.politica-da-saude-e-seguranca')); ?>" class="btn btn-primary my-2">Política de Saúde e Segurança</a><br>
						<a href="<?php echo e(url_locale('empresa.plano-de-contingencia')); ?>" class="btn btn-primary my-2">Plano de Contingência COVID-19</a><br>
						...
						<a href="<?php echo e(url_locale('empresa.politica-de-etica-empresarial-e-sustentabilidade')); ?>" class="btn btn-primary my-2">Política de Ética empresarial e Sustentabilidade</a><br>
					</div>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/governanca-e-compliance/index.blade.php ENDPATH**/ ?>