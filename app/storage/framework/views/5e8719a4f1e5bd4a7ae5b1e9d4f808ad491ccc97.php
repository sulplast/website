...
<body>
	<div class="main">
		...
		<!-- Subpage header -->
		<?php echo $__env->make('frontend.layouts.components.sp-header', ['title' => 'Canal de transparência'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('canal-de-transparencia'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
                        <p class="lead">Ética, integridade e transparência são valores fundamentais para a <strong>Sulplast</strong>. Por isso, exigimos de todos os colaboradores e parceiros alinhamento total à nossa <a href="<?php echo e(url_locale('empresa.politica-de-etica-empresarial-e-sustentabilidade')); ?>" target="_blank">Política de Ética Empresarial e Sustentabilidade</a>.</p>
                        ...
                        <?php echo $__env->make('frontend.canal-transparencia.partials.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					</div>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/canal-transparencia/index.blade.php ENDPATH**/ ?>