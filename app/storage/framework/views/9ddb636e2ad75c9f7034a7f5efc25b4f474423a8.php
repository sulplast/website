<?php
	$pagina = App\Pagina::returnPage('tecnologias-e-processos-termoplastico-extrusao');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('tecnologia-e-processos-termoplastico-extrusao'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('tecnologias-e-processos-termoplastico-extrusao'); ?>

					</div>
					<?php echo $__env->make('frontend.tecnologia.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/tecnologia/termoplastico/extrusao/index.blade.php ENDPATH**/ ?>