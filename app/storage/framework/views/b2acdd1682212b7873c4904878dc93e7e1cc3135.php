<form action="<?php echo e(url_locale('trabalhe-conosco')); ?>" enctype="multipart/form-data" method="POST">
	...
	<div class="row form-group">
		<div class="col-md-7">
			<label class="control-label" for="nome_completo"><?php echo e(__('trabalhe_conosco.form.nome')); ?></label>
			<input type="text" name="nome_completo" class="form-control-sulplast mask-text-only" required>
		</div>
		<div class="col-md-5">
			<label class="control-label" for="email"><?php echo e(__('trabalhe_conosco.form.email')); ?></label>
			<input type="email" name="email" class="form-control-sulplast" required>
		</div>
	</div>
	<div class="row form-group">
		<div class="col-md-4">
			<label class="control-label" for="telefone"><?php echo e(__('trabalhe_conosco.form.telefone')); ?> (*)</label>
			<input type="text" name="telefone" class="form-control-sulplast telefone">
		</div>
		<div class="col-md-4">
			<label class="control-label" for="cidade"><?php echo e(__('trabalhe_conosco.form.cidade')); ?> (*)</label>
			<input type="text" name="cidade" class="form-control-sulplast mask-text-only">
		</div>
		<div class="col-md-4">
			<label class="control-label" for="estado"><?php echo e(__('trabalhe_conosco.form.estado')); ?> (*)</label>
	...
	<div class="row form-group">
		<div class="col-md-12">
			<label class="control-label" for="mensagem"><?php echo e(__('trabalhe_conosco.form.mensagem')); ?></label>
	...
	<div class="row form-group">
		<div class="col-md-12">
			<div class="input-curriculum-container">
				...
				<hr>
				<p><strong><?php echo e(__('trabalhe_conosco.form.anexo_ajuda')); ?></strong></p>
			</div>
		</div>
	...
	<div class="form-footer-sulplast">
		<small>
			...
			Para mais detalhes sobre o assunto, acesse nossa <a href="<?php echo e(env('APP_URL')); ?>/pt-br/pdf/politica-privacidade.pdf">Política de Privacidade</a>. 
		</small>

		<div class="row form-group" style="margin-top: 20px">
			<div class="col-md-12">
				<button class="btn btn-primary" type="submit"><i class="fa fa-paper-plane"></i>&emsp;<?php echo e(__('trabalhe_conosco.form.submit')); ?></button>
			</div>
		</div>
	</div>
</form>
...
</script><?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/fale-conosco/partials/trabalhe-conosco.blade.php ENDPATH**/ ?>