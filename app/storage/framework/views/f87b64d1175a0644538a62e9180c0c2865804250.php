<?php
	$pagina = App\Pagina::returnPage('empresa-politica-qualidade');
?>
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		<?php echo Breadcrumbs::render('empresa-missao-e-visao'); ?>
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<?php echo App\Conteudo::show('empresa-politica-qualidade'); ?>
...
<?php /**PATH C:\xampp\htdocs\site\app\resources\views/frontend/empresa/politica-qualidade.blade.php ENDPATH**/ ?>