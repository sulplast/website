	...
	<div class="main">
		...
		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						{!! App\Conteudo::show('empresa-quem-somos') !!}
						<br>
						<img class="img-responsive" src="{{ asset_locale('/images/foto-aerea-sulplast.jpg') }}" alt="Foto aérea Sulplast em 2011" title="Foto aérea - Sulplast em 2011">
					</div>
					
					@include('frontend.empresa.partials.sidebar')
