...
<head>
	...
	<title>Comercial | Sulplast - Fibra de vidro e Termoplástico</title>
...
<body>
	<div class="main">
		...
		<!-- Subpage header -->
		@include('frontend.layouts.components.sp-header', ['title' => 'Comercial'])

		<!-- Breadcrumbs -->
		{!! Breadcrumbs::render('comercial') !!}

		<div class="sp-content">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
                        @include('frontend.comercial.partials.form')
					</div>
				</div>
			</div>
		</div>
