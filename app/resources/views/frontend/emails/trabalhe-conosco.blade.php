...
<body>
	...
	<ul>
		@if (isset($input['vaga']))
			<li><strong>Vaga:</strong> {{ !empty($input['vaga']) ? $input['vaga'] : 'Não informado(a)' }}</li>
		@endif
		...
		<li><strong>Departamento de interesse:</strong> {{ !empty($input['departamento']) ? $input['departamento'] : 'Não informado(a)' }}</li>
	</ul>
	<hr />
	<h4>Mensagem</h4>
