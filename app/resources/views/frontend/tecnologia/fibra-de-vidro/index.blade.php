@php
	$pagina = App\Pagina::returnPage('tecnologias-e-processos-fibra-de-vidro');
@endphp
<!DOCTYPE html>
...
<body>
	<div class="main">
		...
		<!-- Breadcrumbs -->
		{!! Breadcrumbs::render('tecnologia-e-processos-fibra-de-vidro') !!}
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-12">
								{!! App\Conteudo::show('fibra-de-vidro-intro') !!}
							</div>
						</div>
					</div>
